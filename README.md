...
<UL>
  ...
  <LI>메인 페이지에는 4개씩 상영영화를 보여줍니다.  </LI>
...
<img src="https://github.com/JeongYoun-24/Project_New/assets/126854252/e55fb464-d0f2-4d98-989d-3ae778db7d54" height="350">
...
처음으로 만들어보는 개인 프로젝트입니다.<BR>
이번 프로젝트를 통해 엔티티간의 매핑 관계와 스프링 부트의 기본적인 개념들에 대해서 많은 공부를 했으며 아직 부족한점을 찾을수있었습니다. <BR>
기억나는 점은 설계 단계를 꼼꼼히 해야한다는 것과 다음에는 API를 적극 활용할것 을 생각했습니다. <BR>
설계 단계를 재대로 못한점 때문에 중간중간 많이 꼬여버려서 시간을 많이 낭비하여 아쉬웠습니다. <BR>
그래서 다음 프로젝트를 진행 한다면 설계 단계부터 꼼꼼히 설계할 것 같습니다.<BR>
